...
public class BlackHoleEffect : MonoBehaviour
{
    ...
    [SerializeField] Anomaly blackHole;
    ...
    private void OnRenderImage(RenderTexture source, RenderTexture destination)
    {
        ...
        {
            wtsp = cam.WorldToScreenPoint(blackHole.transform.position);
    ...
    public void StartEffect(Anomaly blackHole)
    {
        if(this.blackHole) this.blackHole.RemoveAnomaly();
